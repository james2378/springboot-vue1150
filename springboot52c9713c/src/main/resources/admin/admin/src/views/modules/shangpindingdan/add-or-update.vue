	...
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"14px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="购买数量" prop="shuliang">
					<el-input v-model="ruleForm.shuliang" onkeyup="this.ruleForm.shuliang=this.ruleForm.shuliang.replace(/[^\d]/g,'')" placeholder="购买数量" clearable  :readonly="ro.shuliang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="购买数量" prop="shuliang">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="实付价格" prop="yue">
					<el-input v-model="yue" placeholder="实付价格" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.yue" label="实付价格" prop="yue">
					<el-input v-model="ruleForm.yue" placeholder="实付价格" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="date" v-if="type!='info'" label="购买时间" prop="goumaishijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.goumaishijian" label="购买时间" prop="goumaishijian">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="用户余额" prop="yonghuyue">
					<el-input-number v-model="ruleForm.yonghuyue" placeholder="用户余额" :readonly="ro.yonghuyue"></el-input-number>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="用户余额" prop="yonghuyue">
					<el-input v-model="ruleForm.yonghuyue" placeholder="用户余额" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="会员等级" prop="huiyuandengji">
		...
		init(id,type) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					if(((json.huiyuandengji!=''&&json.huiyuandengji) || json.huiyuandengji==0) && this.$storage.get("role")!="管理员"){
