	...
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"14px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="余额" prop="yue">
					<el-input-number v-model="ruleForm.yue" placeholder="余额" :readonly="ro.yue"></el-input-number>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="余额" prop="yue">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="select" v-if="type!='info'"  label="会员折扣" prop="huiyuanzhekou">
					<el-select :disabled="ro.huiyuanzhekou" v-model="ruleForm.huiyuanzhekou" placeholder="请选择会员折扣" >
						<el-option
							v-for="(item,index) in huiyuanzhekouOptions"
							v-bind:key="index"
							:label="item"
							:value="item">
						</el-option>
	...
	methods: {
		...
		init(id,type) {
            ...
            this.$http({
				...
				if (data && data.code === 0) {
					this.huiyuanzhekouOptions = data.data;
				} else {
					this.$message.error(data.msg);
				}
            });
