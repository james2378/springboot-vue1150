	...
	<div class="main-content" :style='{"color":"#666","padding":"20px 30px 30px","fontSize":"14px"}'>
		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"padding":"20px","boxShadow":"0 1px 10px 1px rgba(115,108,203,.1)","margin":"0px","overflow":"hidden","borderRadius":"3px","background":"#fff","fontSize":"inherit"}' :inline="true" :model="searchForm">
				<el-row :style='{"width":"100%","padding":"10px","fontSize":"inherit","textAlign":"left","background":"#fff","display":"block"}' v-if="!forumChild">
				...
				<el-row :style='{"width":"100%","padding":"10px","fontSize":"inherit","textAlign":"left","background":"#fff","display":"block"}' v-if="forumChild">
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 20px","outline":"none","color":"#fff","borderRadius":"4px","background":"#2bb3c0","width":"auto","fontSize":"inherit","transition":"all 0.3s","height":"40px"}' type="success" @click="search()">返回</el-button>
				</el-row>
