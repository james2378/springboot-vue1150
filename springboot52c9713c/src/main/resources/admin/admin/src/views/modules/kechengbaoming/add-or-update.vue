	...
	<div class="addEdit-block" :style='{"padding":"30px","fontSize":"14px","color":"#666","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="课程简介" prop="kechengjianjie">
					<el-input v-model="ruleForm.kechengjianjie"  placeholder="课程简介" clearable  :readonly="ro.kechengjianjie"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="课程简介" prop="kechengjianjie">
					<el-input v-model="ruleForm.kechengjianjie" placeholder="课程简介" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="date" v-if="type!='info'" label="购报名间" prop="goubaomingjian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
						v-model="ruleForm.goubaomingjian" 
						type="datetime"
						:readonly="ro.goubaomingjian"
						placeholder="购报名间"
					></el-date-picker>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.goubaomingjian" label="购报名间" prop="goubaomingjian">
					<el-input v-model="ruleForm.goubaomingjian" placeholder="购报名间" readonly></el-input>
				</el-form-item>
