<template>
	<div id="tags-view-container" class="tags-view-container" :style='{"padding":"8px 22px","boxShadow":"0 1px 3px 0 rgb(0 0 0 / 12%), 0 0 3px 0 rgb(0 0 0 / 4%)","margin":"0 auto","borderColor":"#d8dce5","overflow":"hidden","background":"linear-gradient(180deg, rgba(240,240,240,1) 0%, rgba(255,255,255,1) 6%, rgba(255,255,255,1) 100%, #fff","borderWidth":"0 0 1px","display":"none","width":"calc(100% - 0px)","fontSize":"14px","borderStyle":"solid","height":"auto"}'>
		<scroll-pane ref="scrollPane" class="tags-view-wrapper">
			<div class="tags-view-box" :style='{"width":"auto","padding":"0px","whiteSpace":"nowrap","position":"relative","background":"none"}'>
