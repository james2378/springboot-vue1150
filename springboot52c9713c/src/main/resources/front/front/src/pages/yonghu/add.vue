...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}'  label="会员等级" prop="huiyuandengji">
            <el-select v-model="ruleForm.huiyuandengji" placeholder="请选择会员等级" :disabled="true  ||ro.huiyuandengji" >
              <el-option
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}'  label="会员折扣" prop="huiyuanzhekou">
            <el-select v-model="ruleForm.huiyuanzhekou" placeholder="请选择会员折扣" :disabled="true  ||ro.huiyuanzhekou" >
              <el-option
    ...
    methods: {
      ...
      init(type) {
        ...
        this.$http.get('option/huiyuanka/huiyuanzhekou', {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
            this.huiyuanzhekouOptions = res.data.data;
          }
        });
