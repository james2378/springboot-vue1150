...
<div :style='{"width":"100%","padding":"30px 7% 40px","margin":"0px auto","position":"relative","background":"#fff"}'>
    ...
    >
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}'  label="会员等级" prop="huiyuandengji">
            <el-select v-model="ruleForm.huiyuandengji" placeholder="请选择会员等级" :disabled=" false  ||ro.huiyuandengji" >
              <el-option
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="会员卡金额" prop="yue">
            <el-input v-model.number="ruleForm.yue" 
                placeholder="会员卡金额" clearable :disabled=" false  ||ro.yue"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="会员功能" prop="huiyuangongneng">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="会员功能"
...
<script>
  export default {
    ...
    // 多级联动参数
      // 多级联动参数
      info() {
        this.$http.get(`huiyuanka/detail/${this.$route.query.id}`, {emulateJSON: true}).then(res => {
          if (res.data.code == 0) {
					...
					if(crossrefid && crossuserid) {
						...
						this.$http.get('huiyuanka/list', {
							...
							if(res.data.data.total>=crossoptnum) {
								...
								this.$http.post(`huiyuanka/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(res => {
									if (res.data.code == 0) {
										this.$message({
											message: '操作成功',
											type: 'success',
