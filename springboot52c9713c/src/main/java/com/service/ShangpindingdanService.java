...
public interface ShangpindingdanService extends IService<ShangpindingdanEntity> {
    ...
    List<Map<String, Object>> selectValue(Map<String, Object> params,Wrapper<ShangpindingdanEntity> wrapper);

    List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params,Wrapper<ShangpindingdanEntity> wrapper);

    List<Map<String, Object>> selectGroup(Map<String, Object> params,Wrapper<ShangpindingdanEntity> wrapper);
